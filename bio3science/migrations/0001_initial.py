# Generated by Django 3.1 on 2020-11-16 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('communities', models.ManyToManyField(blank=True, related_name='projects', to='bio3science.Community')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_university', to='bio3science.university'),
        ),
        migrations.AddField(
            model_name='project',
            name='universities',
            field=models.ManyToManyField(blank=True, related_name='projects', to='bio3science.University'),
        ),
        migrations.AddField(
            model_name='project',
            name='users',
